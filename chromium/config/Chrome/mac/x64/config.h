...
/* #define FFMPEG_CONFIGURATION "--disable-everything --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-static --enable-avcodec --enable-avformat --enable-avutil --enable-static --enable-libopus --enable-libdav1d --enable-protocols --enable-demuxers --disable-avfilter --disable-avdevice --disable-programs --disable-network --disable-bsfs --disable-demuxer=voc --disable-decoder=alias_pix --disable-decoder=brender_pix --disable-debug --disable-iconv --disable-autodetect --enable-decoder='vorbis,libopus,flac,mjpeg,mpeg4,msmpeg4v1,msmpeg4v2,msmpeg4v3,h263,vp8,theora,vp9,hevc,h264,flv,mpeg1video,mpeg2video,av1,libdav1d' --enable-decoder='pcm_u8,pcm_s16le,pcm_s24le,pcm_s32le,pcm_f32le,mp3' --enable-decoder='pcm_s16be,pcm_s24be,pcm_mulaw,pcm_alaw' --enable-demuxer='ogg,matroska,wav,flac,mp3,mov,avi,asf,mjpeg,flv,mpegts,mpegvideo' --enable-parser='opus,vorbis,flac,mpegaudio,vp9,mjpeg,mpeg4video,hevc,h264,vp8,av1' --enable-protocol=file --extra-cflags=-I/Volumes/Projects/projects/jaxima.com/jaxima/src/third_party/opus/src/include --extra-cflags=-I/Volumes/Projects/projects/jaxima.com/jaxima/src/third_party/dav1d/libdav1d/include --disable-linux-perf --x86asmexe=nasm --ar=llvm-ar --nm=llvm-nm --ranlib=true --strip=llvm-strip --optflags='\0-O2\0' --enable-pic --cc=clang --cxx=clang++ --ld=clang --extra-cflags='-isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk' --extra-ldflags='-isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk -Wl,-flat_namespace -Wl,-undefined,dynamic_lookup' --host-cflags='-isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk' --host-ldflags='-isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk' --arch=x86_64 --extra-cflags='-arch x86_64 -m64' --extra-ldflags='-arch x86_64' --enable-decoder=aac --enable-demuxer=aac --enable-parser=aac" -- elide long configuration string from binary */
...
// === Jaxima Devices Service: VP8/VP9 Force Enable ===
